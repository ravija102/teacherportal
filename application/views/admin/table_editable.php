					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
                                                                    <a href="<?=base_url()?>index.php/admin/login/add_user"><button id="" class="btn green">
							...
							<tr>
								...
								<td>
									<a class="" href="<?=base_url()?>index.php/admin/login/edit_user/<?=$u->id?>">Edit</a>
								</td>
								<td>
									<a class="" href="<?=base_url()?>index.php/admin/login/delete_user/<?=$u->id?>">Delete</a>
								</td>
							</tr>
                                                       <?php } ?>
