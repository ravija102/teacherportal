...
<!--							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
                                                        <form action="<?=base_url()?>index.php/admin/staff/edit_staff/<?=$staff_data[0]->id?>" id="form_sample_1" class="form-horizontal" method="post">
								<div class="form-body">
                                                                    <div class="error1">
...
<!--									<div class="alert alert-danger display-hide">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
                                                                                    <input type="text" name="name" data-required="1" class="form-control" value="<?=$staff_data[0]->name?>"/>
                                                                                    <div class="error">
                                                                                        <?=form_error('name')?>
                                                                                    </div>
										</div>
								...
								<div class="form-actions fluid">
									<div class="col-md-offset-3 col-md-9">
										<button type="submit" class="btn green">Submit</button>
										<a href="<?=base_url()?>index.php/admin/staff" type="button" class="btn default">Cancel</a>
									</div>
								</div>
							</form>
							<!-- END FORM-->
