					...
					<div class="portlet box light-grey">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
                                                                    <a href="<?=base_url()?>index.php/admin/staff/add_staff" id="sample_editable_1_new" class="btn green">
							...
							<tr class="odd gradeX">
								...
								<td>
									<?=$staff_data->createdon?>
								</td>
								<td class="center">
                                                                    <a href="<?=base_url()?>index.php/admin/staff/edit_staff/<?=$staff_data->id?>">Edit</a>
								</td>
								<td>
									<span class="">
                                                                            <a href="<?=base_url()?>index.php/admin/staff/delete_staff/<?=$staff_data->id?>" onclick="return deletechecked()">Delete</a>
									</span>
								</td>
                                                            </tr><?php }?>
<!--							<tr class="odd gradeX">
