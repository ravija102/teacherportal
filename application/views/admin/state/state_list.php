				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>State List
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
                                                                    <a href="<?=base_url()?>index.php/admin/state/add_state" id="sample_editable_1_new" class="btn green">
							...
							<tr class="odd gradeX">
								...
								<td>
									<?=$state_data->createdon?>
								</td>
								<td class="center">
                                                                    <a href="<?=base_url()?>index.php/admin/state/edit_state/<?=$state_data->id?>">Edit</a>
								</td>
								<td>
									<span class="">
                                                                            <a href="<?=base_url()?>index.php/admin/state/delete_state/<?=$state_data->id?>" onclick="return deletechecked()">Delete</a>
									</span>
								</td>
                                                            </tr><?php }?>
<!--							<tr class="odd gradeX">
