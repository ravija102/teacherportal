				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Plan List
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
                                                                    <a href="<?=base_url()?>index.php/admin/plan_detail/add_plan" id="sample_editable_1_new" class="btn green">
							...
							<tr class="odd gradeX">
								...
								<td class="center">
                                                                    <a href="<?=base_url()?>index.php/admin/plan_detail/edit_plan/<?=$plan_data->id?>">Edit</a>
								</td>
								<td>
									<span class="">
                                                                            <a href="<?=base_url()?>index.php/admin/plan_detail/delete_plan/<?=$plan_data->id?>" onclick="return deletechecked()">Delete</a>
									</span>
								</td>
                                                            </tr><?php }?>
<!--							<tr class="odd gradeX">
