			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Edit Plan
							</div>
<!--							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
                                                        <form action="<?=base_url()?>index.php/admin/plan_detail/edit_plan/<?=$plan_detail[0]->id?>" id="form_sample_1" class="form-horizontal" method="post">
								<div class="form-body">
                                                                    <div class="error1">
...
<!--									<div class="alert alert-danger display-hide">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
                                                                                    <input type="text" name="name" data-required="1" class="form-control" value="<?=$plan_detail[0]->name?>"/>
                                                                                    <div class="error">
                                                                                        <?=form_error('name')?>
                                                                                    </div>
										</div>
										...
										<div class="col-md-4">
                                                                                    <input type="text" name="price" data-required="1" class="form-control" value="<?=$plan_detail[0]->price?>"/>
                                                                                    <div class="error">
                                                                                        <?=form_error('price')?> 
                                                                                    </div>
										</div>
										...
										<div class="col-md-4">
                                                                                    <textarea  name="description" data-required="1" class="form-control"><?=$plan_detail[0]->description?></textarea>
                                                                                    <div class="error">
