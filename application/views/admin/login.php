...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
        <form class="login-form" id="loginform" action="<?=base_url()?>index.php/admin/login" method="post">
            <div id='errMsgDiv' name='errMsgDiv' class='errMsg' align="center">
		...
		<div class="form-actions">
			...
			<input type="checkbox" name="remember" value="1"/> Remember me </label>
                    <button type="submit" class="btn green pull-right" onclick="return validateLogin()">
