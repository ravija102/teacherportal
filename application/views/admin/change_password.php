...
<!--				<div class="toggler">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Change Password <small>Change Password</small>
					</h3>
...
<!--							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
                                                        <form action="<?=base_url()?>index.php/admin/login/change_password" id="form_sample_1" class="form-horizontal" method="post">
								<div class="form-body">
                                                                    <div class="error1">
...
<!--									<div class="alert alert-danger display-hide">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
                                                                                    ...
                                                                                    <input type="password" name="current_password" data-required="1" class="form-control" value=""/>
                                                                                    <div class="error">
