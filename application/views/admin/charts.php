			...
			<li class="dropdown user">
				...
				<ul class="dropdown-menu">
					...
					<li>
						...
						<i class="fa fa-move"></i> Full Screen </a>
					</li>
					<li>
							...
							<ul class="sub-menu">
								<li>
									...
									<ul class="sub-menu">
										<li>
											<a href="#">
											<i class="fa fa-remove"></i> Sample Link 1 </a>
										</li>
										<li>
											<a href="#">
...
<script src="<?=base_url('public_html/plugins/flot/jquery.flot.js');?>"></script>
<script src="<?=base_url('public_html/plugins/flot/jquery.flot.resize.js');?>"></script>
<script src="<?=base_url('public_html/plugins/flot/jquery.flot.pie.js');?>"></script>
<script src="<?=base_url('public_html/plugins/flot/jquery.flot.stack.js');?>"></script>
<script src="<?=base_url('public_html/plugins/flot/jquery.flot.crosshair.js');?>"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?=base_url('public_html/scripts/app.js');?>"></script>
<script src="<?=base_url('public_html/scripts/charts.js');?>"></script>
<script>
