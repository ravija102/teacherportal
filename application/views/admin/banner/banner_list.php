					...
					<div class="portlet box light-grey">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
                                                                    <a href="<?=base_url()?>index.php/admin/banner/add_banner" id="sample_editable_1_new" class="btn green">
							...
							<tr class="odd gradeX">
								...
								<td>
									<?=$banner_data->banner_name?>
								</td>
                                                                <td style="display: none">
									<a href="mailto:shuxer@gmail.com">shuxer@gmail.com</a>
								</td>
								<td>
									<?=$banner_data->createdon?>
								</td>
								<td class="center">
                                                                    <a href="<?=base_url()?>index.php/admin/banner/edit_banner/<?=$banner_data->id?>">Edit</a>
								</td>
								<td>
									<span class="">
                                                                            <a href="<?=base_url()?>index.php/admin/banner/delete_banner/<?=$banner_data->id?>" onclick="return deletechecked()">Delete</a>
									</span>
								</td>
                                                            </tr><?php }?>
<!--							<tr class="odd gradeX">
