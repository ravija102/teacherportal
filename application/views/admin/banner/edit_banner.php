			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Edit Banner
							</div>
<!--							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
                                                        <form action="<?=base_url()?>index.php/admin/banner/edit_banner/<?=$banner_data[0]->id?>" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
								<div class="form-body">
                                                                    <div class="error1">
                                                                        <?php  //echo validation_errors(); ?>
                                                                        <?=(isset($error_file) ? $error_file['error'] : '');?>
                                                                    </div>
<!--									<div class="alert alert-danger display-hide">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Upload Banner
										<span class="required">
											*
										</span>
										</label>
										<div class="col-md-4">
                                                                                    <input type="file" name="banner_name" data-required="1" class="" />
                                                                                    <input type="hidden" name="hidden_name" value="<?=$banner_data[0]->banner_name?>"/>
                                                                                    <div class="error">
										...
										<div class="col-md-4">
                                                                                    <textarea  name="description" data-required="1" class="form-control"><?=$banner_data[0]->description?></textarea>
                                                                                    <div class="error">
								...
								<div class="form-actions fluid">
									<div class="col-md-offset-3 col-md-9">
										<button type="submit" class="btn green">Submit</button>
                                                                                <a href="<?=base_url()?>index.php/admin/banner" type="button" class="btn default">Cancel</a>
									</div>
								</div>
							</form>
							<!-- END FORM-->
