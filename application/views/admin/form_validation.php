...
<!--							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
                                                        <form action="<?=base_url()?>index.php/admin/login/add_user" id="form_sample_1" class="form-horizontal" method="post">
								<div class="form-body">
                                                                    <div class="error1">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="radio-list" data-error-container="#form_2_membership_error">
												<label>
												<input type="radio" name="user_type" value="male"/>
												Male </label>
												<label>
												<input type="radio" name="user_type" value="female"/>
												Female </label>
                                                                                                <div class="error">
