...
<link href="<?=base_url('public_html/plugins/gritter/css/jquery.gritter.css');?>" rel="stylesheet" type="text/css"/>
<link href="<?=base_url('public_html/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css');?>" rel="stylesheet" type="text/css"/>
<link href="<?=base_url('public_html/plugins/fullcalendar/fullcalendar/fullcalendar.css');?>" rel="stylesheet" type="text/css"/>
<link href="<?=base_url('public_html/plugins/jqvmap/jqvmap/jqvmap.css');?>" rel="stylesheet" type="text/css"/>
<link href="<?=base_url('public_html/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css');?>" rel="stylesheet" type="text/css"/>
...
<link href="<?=base_url('public_html/css/pages/tasks.css');?>" rel="stylesheet" type="text/css"/>
				...
				<ul class="dropdown-menu">
					<li>
						<a href="<?php echo base_url()?>index.php/admin/login/edit_user/<?=$this->session->userdata('admin_id')?>"><i class="fa fa-user"></i> My Profile</a>
                                        ...
                                        <li>
						<a href="<?php echo base_url()?>index.php/admin/login/add_user"><i class="fa fa-user"></i> Add User</a>
					</li>
					<li>
						<a href="<?=base_url()?>index.php/admin/login/change_password"><i class="fa fa-lock"></i> Change Password</a>
					</li>
					<li>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start active ">
					<a href="<?=base_url()?>index.php/admin/login/data">
...
<!--				<li class="">
				...
				<li class="">
					...
					<ul class="sub-menu">
						<li>
							<a href="<?=base_url()?>index.php/admin/school_type">
						...
						<li>
							<a href="<?=base_url()?>index.php/admin/plan_detail">
							<span class="badge badge-roundless badge-important">
								new
							</span>
							Plan Detail List</a>
						...
						<li>
							<a href="<?=base_url()?>index.php/admin/grade_level">
							Grade Level List</a>
						</li>
						<li>
							<a href="<?=base_url()?>index.php/admin/staff">
							Staff List</a>
						</li>
						<li>
							<a href="<?=base_url()?>index.php/admin/cms">
							CMS List</a>
						</li>
						<li>
							<a href="<?=base_url()?>index.php/admin/country">
							Country List</a>
						</li>
						<li>
							<a href="<?=base_url()?>index.php/admin/state">
							<span class="badge badge-roundless badge-important">
								new
							</span>
							State List</a>
				...
				<li id="frontend-link" class="tooltips" data-placement="right" data-original-title="Frontend&nbsp;Theme For&nbsp;Metronic&nbsp;Admin">
					<a href="<?=base_url()?>index.php/admin/banner" target="">
					...
					<div class="portlet solid bordered light-grey">
						...
						<div class="portlet-body">
							<div id="site_statistics_loading">
								<img src="<?=base_url('public_html/img/loading.gif');?>" alt="loading"/>
							</div>
										...
										<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
											<div class="row">
												<div class="col-md-6 user-info">
													<img alt="" src="<?=base_url('public_html/img/avatar.png');?>" class="img-responsive"/>
													<div class="details">
														<div>
											...
											<div class="row">
												<div class="col-md-6 user-info">
													<img alt="" src="assets/<?=base_url('public_html/img/avatar.png');?>" class="img-responsive"/>
													<div class="details">
														<div>
															<a href="#">Eric Kim</a>
															<span class="label label-sm label-info">
					...
					<div class="portlet">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
										<img class="avatar img-responsive" alt="" src="<?=base_url('public_html/img/avatar1.jpg');?>"/>
										<div class="message">
											<span class="arrow">
											</span>
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="<?=base_url('public_html/img/avatar2.jpg');?>"/>
										<div class="message">
											<span class="arrow">
											</span>
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="<?=base_url('public_html/img/avatar3.jpg');?>"/>
										<div class="message">
											<span class="arrow">
											</span>
...
<script src="<?=base_url('public_html/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js');?>" type="text/javascript"></script>
...
<script src="<?=base_url('public_html/plugins/jqvmap/jqvmap/jquery.vmap.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/flot/jquery.flot.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/flot/jquery.flot.resize.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/jquery.pulsate.min.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/bootstrap-daterangepicker/moment.min.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/bootstrap-daterangepicker/daterangepicker.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/gritter/js/jquery.gritter.js');?>" type="text/javascript"></script>
<!-- IMPORTANT! fullcalendar depends on jquery-ui-1.10.3.custom.min.js for drag & drop support -->
<script src="<?=base_url('public_html/plugins/fullcalendar/fullcalendar/fullcalendar.min.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/plugins/jquery.sparkline.min.js');?>" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?=base_url('public_html/scripts/app.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/scripts/index.js');?>" type="text/javascript"></script>
<script src="<?=base_url('public_html/scripts/tasks.js');?>" type="text/javascript"></script>
