			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Add CMS
							</div>
<!--							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
                                                        <form action="<?=base_url()?>index.php/admin/cms/add_cms" id="form_sample_1" class="form-horizontal" method="post">
								<div class="form-body">
                                                                    <div class="error1">
...
<!--									<div class="alert alert-danger display-hide">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
                                                                                    <input type="text" name="content" data-required="1" class="form-control" value="<?=set_value('content')?>"/>
                                                                                    <div class="error">
                                                                                        <?=form_error('content')?>
                                                                                    </div>
										</div>
										...
										<div class="col-md-4">
                                                                                    <input type="text" name="url" data-required="1" class="form-control" value="<?=set_value('url')?>"/>
                                                                                    <div class="error">
                                                                                        <?=form_error('url')?>  
                                                                                    </div>
										</div>
										...
										<div class="col-md-4">
                                                                                    <input type="text" name="meta_title" data-required="1" class="form-control" value="<?=set_value('meta_title')?>"/>
                                                                                    <div class="error">
										...
										<div class="col-md-4">
                                                                                    <textarea  name="meta_description" data-required="1" class="form-control"><?=set_value('meta_description')?></textarea>
                                                                                    <div class="error">
										...
										<div class="col-md-4">
                                                                                    <textarea name="template" id="template" data-required="1" class="form-control"><?=set_value('template')?></textarea>
                                                                                    <div class="error">
                                                                                        <?=form_error('template')?>
                                                                                    </div>
										</div>
