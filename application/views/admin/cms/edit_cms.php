...
<!-- BEGIN CkEditer Script -->  
    <script type="text/javascript" src="<?=base_url('public_html/ckeditor/ckeditor.js');?>"></script>
    <script type="text/javascript" src="<?=base_url('public_html/ckfinder/ckfinder.js');?>"></script>
<!-- BEGIN CkEditer Script -->
<meta charset="utf-8"/>
...
<!--							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
                                                        <form action="<?=base_url()?>index.php/admin/cms/edit_cms/<?=$cms_data[0]->id?>" id="form_sample_1" class="form-horizontal" method="post">
								<div class="form-body">
                                                                    <div class="error1">
...
<!--									<div class="alert alert-danger display-hide">
									...
									<div class="form-group">
										<label class="control-label col-md-3">CMS Name
										<span class="required">
											*
										</span>
										</label>
										<div class="col-md-4">
                                                                                    <input type="text" name="name" data-required="1" class="form-control" value="<?=$cms_data[0]->name?>"/>
                                                                                    <div class="error">
                                                                                        <?=form_error('name')?>
                                                                                    </div>
										</div>
										...
										<div class="col-md-4">
                                                                                    <input type="text" name="content" data-required="1" class="form-control" value="<?=$cms_data[0]->content?>"/>
                                                                                    <div class="error">
                                                                                        <?=form_error('content')?> 
                                                                                    </div>
										</div>
										...
										<div class="col-md-4">
                                                                                    <input type="text" name="url" data-required="1" class="form-control" value="<?=$cms_data[0]->url?>"/>
                                                                                    <div class="error">
                                                                                        <?=form_error('url')?> 
                                                                                    </div>
										</div>
										...
										<div class="col-md-4">
                                                                                    <input type="text" name="meta_title" data-required="1" class="form-control" value="<?=$cms_data[0]->meta_title?>"/>
                                                                                    <div class="error">
										...
										<div class="col-md-4">
                                                                                    <textarea  name="meta_description" data-required="1" class="form-control"><?=$cms_data[0]->meta_description?></textarea>
                                                                                    <div class="error">
										...
										<div class="col-md-4">
                                                                                    <textarea  name="template" id="template" data-required="1" class="form-control"><?=$cms_data[0]->template?></textarea>
                                                                                    <div class="error">
                                                                                        <?=form_error('template')?>
                                                                                    </div>
										</div>
								...
								<div class="form-actions fluid">
									<div class="col-md-offset-3 col-md-9">
										<button type="submit" class="btn green">Submit</button>
                                                                                <a href="<?=base_url()?>index.php/admin/cms" type="button" class="btn default">Cancel</a>
									</div>
								</div>
							</form>
							<!-- END FORM-->
